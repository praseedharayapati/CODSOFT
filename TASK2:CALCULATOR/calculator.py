...
if __name__ == "__main__":
	...
	equal = Button(gui, text=' = ', fg='black', bg='white',command=equalpress, height=1, width=28)
	equal.grid(row=6, columnspan=12)

	clear = Button(gui, text='Clear', fg='black', bg='white',command=clear, height=1, width=14)
	clear.grid(row=5, columnspan=6)
